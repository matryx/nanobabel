...
*FPT_NOINFO = *Chemistry::OpenBabelc::OBFingerprint_FPT_NOINFO;
*Flags = *Chemistry::OpenBabelc::OBFingerprint_Flags;
*SetFlags = *Chemistry::OpenBabelc::OBFingerprint_SetFlags;
...
*ReadIndex = *Chemistry::OpenBabelc::FptIndex_ReadIndex;
*ReadHeader = *Chemistry::OpenBabelc::FptIndex_ReadHeader;
