...
void usage()
{
  ...
  std::cout << "    -cx FILE      atom constraint file" << std::endl;
  std::cout << "    -ff FFID      select a forcefield (default=UFF)" << std::endl;
  std::cout << "    -h            add hydrogen atoms" << std::endl;
  std::cout << "    -n steps      specify the maximum numer of steps (default=2500)" << std::endl;
}
...
void runConfig(int argc, char **argv)
{
  ...
  std::cout << std::endl;
  std::cout << " - Environment BABEL_VERSION:" << std::endl;
  std::cout << BABEL_VERSION << std::endl;
  std::cout << std::endl;
  std::cout << " - Environment MODULE_EXTENSION:" << std::endl;
