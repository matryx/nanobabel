...
cmake.exe ^
    ...
    -DLIBXML2_LIBRARIES="%CD%\..\libs\i386\libxml2.lib" ^
    -DMINIMAL_BUILD=OFF ^
    -DCAIRO_INCLUDE_DIRS="%CD%\..\include\cairo" ^
    -DCAIRO_LIBRARIES="%CD%\..\libs\i386\cairo.lib" ^
    -DLIBXML2_INCLUDE_DIR=. ^
    -DZLIB_LIBRARY="%CD%\..\libs\i386\zlib1.lib" ^
    -DZLIB_INCLUDE_DIR=. ^
    -DINCHI_LIBRARY="%CD%\..\libs\i386\libinchi.lib" ^
    -DINCHI_INCLUDE_DIR=. ^
    -DXDR_LIBRARY="%CD%\..\libs\i386\xdr.lib" ^
