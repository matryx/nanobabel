...
namespace OpenBabel
{
  ...
  **/
                           ...
                           const std::string& envvar)
  {
    ...
    if(ifs)
    {
      //std::cout << "Found file mode0 " << filename << std::endl;
      return filename;
    }

    string file;
    #ifdef BABEL_NOENV
      const char* datadir = BABEL_DATADIR;
    #else
    ...
    if(ifs)
    {
      //std::cout << "Found file mode1 " << datadir << " -> " << file << std::endl;
      return file;
    }
    ...
    if (ifs)
    {
      //std::cout << "Found file mode2 " << datadir << " -> " << file << std::endl;
      return file;
    }

    ifs.clear();
    ifs.close();
    //std::cout << "Not found file " << datadir << std::endl;
    return(""); // error
  }
